...
export function AboutSection({ onDownloadCV }) {
  ...
  return (
    <section id="about" className="relative z-10 w-full min-h-screen bg-white flex flex-col justify-between border-t-4 border-black shadow-[0px_-10px_30px_rgba(0,0,0,0.1)] py-16 md:py-24">
      ...
      {/* Dynamic Marquee at the bottom of About Section */}
