        ...
        <form onSubmit={handleSave} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="text" required className="w-full px-4 py-2 border border-[#E5E5E5] bg-[#FAFAFA] focus:outline-none focus:border-[#666666]" value={formData.period} onChange={(e) => setFormData({...formData, period: e.target.value})} placeholder="e.g. OKT 2024 - FEB 2025" />
            </div>
            <div>
          ...
          <div>
            ...
            <input type="text" required className="w-full px-4 py-2 border border-[#E5E5E5] bg-[#FAFAFA] focus:outline-none focus:border-[#666666]" value={formData.role} onChange={(e) => setFormData({...formData, role: e.target.value})} />
          </div>
          <div>
            <label className="block text-xs font-bold font-mono tracking-wider text-gray-700 mb-2">COMPANY</label>
            <input type="text" required className="w-full px-4 py-2 border border-[#E5E5E5] bg-[#FAFAFA] focus:outline-none focus:border-[#666666]" value={formData.company} onChange={(e) => setFormData({...formData, company: e.target.value})} />
          </div>
          <div>
            <label className="block text-xs font-bold font-mono tracking-wider text-gray-700 mb-2">DESCRIPTION</label>
            <textarea required rows={4} className="w-full px-4 py-2 border border-[#E5E5E5] bg-[#FAFAFA] focus:outline-none focus:border-[#666666]" value={formData.description} onChange={(e) => setFormData({...formData, description: e.target.value})} />
          </div>
