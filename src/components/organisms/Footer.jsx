      ...
      <div className="flex flex-col items-center md:items-end space-y-4">
        <div className="space-x-4 md:space-x-8 text-sm">
          {contact.linkedin_url && (
            <a href={contact.linkedin_url} target="_blank" rel="noreferrer" className="hover:text-[#3B82F6] transition-colors border-b border-transparent hover:border-[#3B82F6] pb-1">LINKEDIN</a>
          )}
          {contact.instagram_url && (
            <a href={contact.instagram_url} target="_blank" rel="noreferrer" className="hover:text-[#3B82F6] transition-colors border-b border-transparent hover:border-[#3B82F6] pb-1">INSTAGRAM</a>
          )}
          {contact.phone_number && (
            <a href={`tel:${contact.phone_number}`} className="hover:text-[#3B82F6] transition-colors border-b border-transparent hover:border-[#3B82F6] pb-1">PHONE</a>
          )}
        </div>
